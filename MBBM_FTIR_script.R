...
# Write csv long
MBBM_hourly_wide <- MBBM_hourly_wide %>% mutate(DATE.TIME = format(MBBM_hourly_wide$DATE.TIME, "%Y-%m-%d %H:%M:%S"))
write_excel_csv(MBBM_hourly_wide,"20250408-15_MBBM_hourly_wide_FTIR.4.csv")       
